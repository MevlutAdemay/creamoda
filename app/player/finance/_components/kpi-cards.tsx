    ...
    <div className="grid grid-cols-3 gap-2 sm:gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
      <Card className="border bg-card shadow-sm">
        ...
        <CardContent className="pt-0 sm:pt-0">
          <p className="text-xs sm:text-xl font-semibold tabular-nums">{formatUsd(balanceUsd)}</p>
        </CardContent>
      </Card>
      <Card className="border bg-card shadow-sm">
        <CardHeader className="pb-0.5 sm:pb-1">
          <CardTitle className="text-[10px] sm:text-xs font-medium text-muted-foreground">Wallet XP</CardTitle>
        </CardHeader>
        <CardContent className="pt-0 sm:pt-0">
      ...
      <Card className="border bg-card shadow-sm">
        <CardHeader className="pb-0.5 sm:pb-1">
          <CardTitle className="text-[10px] sm:text-xs font-medium text-muted-foreground">Wallet Diamond</CardTitle>
        </CardHeader>
        <CardContent className="pt-0 sm:pt-0">
      ...
      <Card className="border bg-card shadow-sm">
        ...
        <CardContent className="pt-0 sm:pt-0">
          <p className="text-xs sm:text-xl font-semibold tabular-nums text-green-600 dark:text-green-400">{formatUsd(kpis.totalIn)}</p>
        </CardContent>
      </Card>
      <Card className="border bg-card shadow-sm">
        <CardHeader className="pb-0.5 sm:pb-1">
        ...
        <CardContent className="pt-0 sm:pt-0">
          <p className="text-xs sm:text-xl font-semibold tabular-nums text-red-600 dark:text-red-400">{formatUsd(kpis.totalOut)}</p>
        </CardContent>
      </Card>
      <Card className="border bg-card shadow-sm">
        <CardHeader className="pb-0.5 sm:pb-1">
        ...
        <CardContent className="pt-0 sm:pt-0">
          ...
          {kpis.biggestExpenseCategory && (
            <p className="text-[10px] sm:text-xs text-muted-foreground mt-0.5 sm:mt-1">Biggest expense: {kpis.biggestExpenseCategory}</p>
          )}
        </CardContent>
      </Card>
    </div>
